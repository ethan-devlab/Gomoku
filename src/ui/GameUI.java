...
public class GameUI extends JPanel {
    ...
    private JLabel p1TimeRemaining;
    private JLabel p2TimeRemaining;
    ...
    public GameUI(JLabel pName, int turnTime, int gameTime, int firstPlayer, int withdraw) {
//        g.drawString(Character.toString((char) ('A' + i)), x0 + size * i - 5, y0 + (ROW) * size);

//        try {
//            // Try loading from resources first
//            URL imageUrl = getClass().getResource("/resources/image/gameboard.png");
//            if (imageUrl != null) {
//                backgroundImage = new ImageIcon(imageUrl).getImage();
//            } else {
//                // Fallback to direct file path
//                File file = new File("src/resources/image/gameboard.png");
//                if (file.exists()) {
...
//        }
    ...
    private void initInfoPanel() {
        ImageIcon blackIcon, whiteIcon, playerIcon, clockIcon, hourGlassIcon;
        ...
        Image hourGlassImg = hourGlassIcon.getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
        Image clockImg = clockIcon.getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
    ...
    private void initHandler() {
        restartHandler = new RestartHandler(GameBoardPanel, this.p1Flag, this.p2Flag);
    ...
    private void initUI() {
        ...
        GameBoardPanel.add(new GameBoardComponent(this.p1Flag, this.p2Flag));
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        p1TimeRemaining = new JLabel();
        p1TimeRemaining.setText("Time Remaining");
        gbc = new GridBagConstraints();
        gbc.gridx = 4;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.EAST;
        InfoPanel.add(p1TimeRemaining, gbc);
        p2TimeRemaining = new JLabel();
        p2TimeRemaining.setText("Time Remaining");
        gbc = new GridBagConstraints();
        gbc.gridx = 6;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        InfoPanel.add(p2TimeRemaining, gbc);
